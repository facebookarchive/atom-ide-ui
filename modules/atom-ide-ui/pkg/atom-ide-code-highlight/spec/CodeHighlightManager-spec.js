...
var _atom = require('atom');var _CodeHighlightManager;

function _load_CodeHighlightManager() {return _CodeHighlightManager = _interopRequireDefault(require('../lib/CodeHighlightManager'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                     *  strict-local
                                                                                                                                                                                                                                     * @format
                                                                                                                                                                                                                                     */describe('CodeHighlightManager', () => {let manager;let provider;let editor;beforeEach(() => {jasmine.useMockClock();waitsForPromise((0, _asyncToGenerator.default)(function* () {editor = yield atom.workspace.open((_nuclideUri || _load_nuclideUri()).default.join(_os.default.tmpdir(), 'test.txt'));
      ...
      provider = {
        ...
        highlight: function (_editor, position) {return Promise.resolve([]);} };
  ...
  it('updates highlights on cursor move', () => {
    ...
    waitsForPromise(() =>
    atom.workspace.open((_nuclideUri || _load_nuclideUri()).default.join(_os.default.tmpdir(), 'test2.txt')));
