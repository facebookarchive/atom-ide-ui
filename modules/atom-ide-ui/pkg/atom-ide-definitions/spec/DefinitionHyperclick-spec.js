...
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('nuclide-commons/UniversalDisposable'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                           * 
                                                                                                                                                                                                                                           * @format
                                                                                                                                                                                                                                           */describe('DefinitionHyperclick', () => {let provider;const definitionProvider = { priority: 20, name: '', grammarScopes: ['text.plain.null-grammar'], getDefinition: () => Promise.resolve(null) };let editor;
  ...
  it('no definition service', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      spyOn(editor, 'getGrammar').andReturn({ scopeName: 'blah' });if (!(
      provider != null)) {throw new Error('Invariant violation: "provider != null"');}if (!(
      provider.getSuggestion != null)) {throw new Error('Invariant violation: "provider.getSuggestion != null"');}
  ...
  it('no definition', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      const spy = spyOn(definitionProvider, 'getDefinition').andReturn(null);if (!(
      provider != null)) {throw new Error('Invariant violation: "provider != null"');}if (!(
      provider.getSuggestion != null)) {throw new Error('Invariant violation: "provider.getSuggestion != null"');}
      const result = yield provider.getSuggestion(editor, position);
  ...
  it('definition - single', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      Promise.resolve(definition));if (!(


      provider != null)) {throw new Error('Invariant violation: "provider != null"');}if (!(
      provider.getSuggestion != null)) {throw new Error('Invariant violation: "provider.getSuggestion != null"');}
      const result = yield provider.getSuggestion(editor, position);if (!(

      result != null)) {throw new Error('Invariant violation: "result != null"');}
      expect(result.range).toEqual(definition.queryRange);
      expect(spy).toHaveBeenCalledWith(editor, position);
      expect(goToLocation).not.toHaveBeenCalled();if (!(

      result != null)) {throw new Error('Invariant violation: "result != null"');}if (!(
      result.callback != null)) {throw new Error('Invariant violation: "result.callback != null"');}if (!(
      typeof result.callback === 'function')) {throw new Error('Invariant violation: "typeof result.callback === \'function\'"');}
      result.callback();
  ...
  it('definition - multiple', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      const spy = spyOn(definitionProvider, 'getDefinition').andReturn(
      Promise.resolve(defs));if (!(


      provider != null)) {throw new Error('Invariant violation: "provider != null"');}if (!(
      provider.getSuggestion != null)) {throw new Error('Invariant violation: "provider.getSuggestion != null"');}
      const result = yield provider.getSuggestion(
      editor,
      position);if (!(
  ...
  it('falls back to lower-priority providers', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      const newProvider = {
        ...
        getDefinition: function () {return Promise.resolve(def);} };

      atom.packages.serviceHub.provide('definitions', '0.1.0', newProvider);if (!(
      provider != null)) {throw new Error('Invariant violation: "provider != null"');}if (!(
      provider.getSuggestion != null)) {throw new Error('Invariant violation: "provider.getSuggestion != null"');}
      const result = yield provider.getSuggestion(editor, position);
      expect(result).not.toBe(null);if (!(
      result != null)) {throw new Error('Invariant violation: "result != null"');}
  ...
  it('does not cache null values', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      provider != null)) {throw new Error('Invariant violation: "provider != null"');}if (!(
      provider.getSuggestion != null)) {throw new Error('Invariant violation: "provider.getSuggestion != null"');}
      let result = yield provider.getSuggestion(editor, position);
      expect(result).toBe(null);

      newProvider.getDefinition = function () {return Promise.resolve(def);};if (!(
      provider.getSuggestion != null)) {throw new Error('Invariant violation: "provider.getSuggestion != null"');}
      result = yield provider.getSuggestion(editor, position);if (!(
      result != null)) {throw new Error('Invariant violation: "result != null"');}
      expect(result.range).toEqual(def.queryRange);
    }));
  });
