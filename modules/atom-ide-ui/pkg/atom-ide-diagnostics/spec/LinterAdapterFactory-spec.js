...
function _load_LinterAdapterFactory() {
  return _LinterAdapterFactory = require('../lib/services/LinterAdapterFactory');
}
...
describe('createAdapter', () => {
  function createAdapterWithMock(linterProviders) {
    return (0, (_LinterAdapterFactory || _load_LinterAdapterFactory()).createAdapter)(linterProviders, jasmine.createSpy());
  }
...
describe('validateLinter', () => {
  ...
  it('should return errors for a linter with no lint function', () => {
    ...
    expect((0, (_LinterAdapterFactory || _load_LinterAdapterFactory()).validateLinter)(linter)).toEqual(['lint function must be specified', 'lint must be a function']);
  });
