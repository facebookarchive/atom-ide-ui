...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}
...
function _load_LinterAdapter() {return _LinterAdapter = require('../lib/services/LinterAdapter');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                 ...
                                                                                                                                                                                                 * 
                                                                                                                                                                                                 * @format
                                                                                                                                                                                                 */const grammar = 'testgrammar';function makePromise(ret, timeout) {return new Promise(resolve => {
    setTimeout(() => {
      resolve(ret);
    }, timeout);
  });
...
describe('LinterAdapter', () => {
  ...
  it('should work when the linter is synchronous', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      textEventSubject.next(fakeEditor);
      const message = yield linterAdapter.
      getUpdates().
      take(1).
      toPromise();
  ...
  function shouldNotInvalidate(value) {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      linterAdapter.getInvalidations().subscribe(function () {return spy();});
      ...
      yield new Promise(function (resolve) {return process.nextTick(resolve);});
...
describe('message transformation functions', () => {
  ...
  describe('linterMessageToDiagnosticMessage', () => {
    function checkMessage(linterMessage, expected) {if (!
      providerName) {throw new Error('Invariant violation: "providerName"');}
      const actual = (0, (_LinterAdapter || _load_LinterAdapter()).linterMessageToDiagnosticMessage)(
      linterMessage,
      providerName);
  ...
  describe('linterMessageV2ToDiagnosticMessage', () => {
    it('should correctly convert messages', () => {
      ...
      expect((0, (_LinterAdapter || _load_LinterAdapter()).linterMessageV2ToDiagnosticMessage)(message, 'test')).toEqual(
      expected);

      expect(
      (0, (_LinterAdapter || _load_LinterAdapter()).linterMessageV2ToDiagnosticMessage)(Object.assign({},
  ...
  describe('linterMessagesToDiagnosticUpdate', () => {
    function runWith(linterMessages) {
      return (0, (_LinterAdapter || _load_LinterAdapter()).linterMessagesToDiagnosticUpdate)(
      currentPath,
      linterMessages,
      providerName);
    ...
    it('should use the LinterProvider name when one is not specified in message', () => {
      ...
      const messages = result.get(fileMessage.filePath);if (!(
      messages != null)) {throw new Error('Invariant violation: "messages != null"');}
    ...
    it('should use the provider name specified in message when available', () => {
      ...
      const messages = result.get(fileMessageWithName.filePath);if (!(
      messages != null)) {throw new Error('Invariant violation: "messages != null"');}
      const resultMessage = messages[0];
    ...
    it('should provide both project messages and file messages', () => {
      ...
      (_nuclideUri || _load_nuclideUri()).default.ensureTrailingSeparator(''));if (!(

      projectMessages != null)) {throw new Error('Invariant violation: "projectMessages != null"');}
