...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('nuclide-commons/nuclideUri'));}var _testHelpers;
function _load_testHelpers() {return _testHelpers = require('nuclide-commons-atom/test-helpers');}var _Hyperclick;
function _load_Hyperclick() {return _Hyperclick = _interopRequireDefault(require('../lib/Hyperclick'));}var _showTriggerConflictWarning;
function _load_showTriggerConflictWarning() {return _showTriggerConflictWarning = _interopRequireDefault(require('../lib/showTriggerConflictWarning'));}var _package;

function _load_package() {return _package = require('../package.json');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                       ...
                                                                                                                                                                       * 
                                                                                                                                                                       * @format
                                                                                                                                                                       */beforeEach(() => {Object.keys((_package || _load_package()).atomConfig).forEach(key => {const config = (_package || _load_package()).atomConfig[key];atom.config.setSchema(`hyperclick.${key}`, Object.assign({}, config, { // To make testing easier, use metaKey on all platforms.
      default: 'metaKey' }));});});

describe('Hyperclick', () => {let setup = (() => {var _ref = (0, _asyncToGenerator.default)(
    ...
    function* () {
      ...
      textEditor = yield atom.workspace.open(
      (_nuclideUri || _load_nuclideUri()).default.join(__dirname, 'fixtures', 'hyperclick.txt'));
      ...
      0];
    });return function setup() {return _ref.apply(this, arguments);};})();
  ...
  /**
                                                                            ...
                                                                            */let textEditor = null;let textEditorView = null;let hyperclick = null;let hyperclickForTextEditor = null;
  ...
  screenPosition)
  {
    ...
    const scrollViewElement = textEditorView.querySelector('.scroll-view');if (!(
    scrollViewElement != null)) {throw new Error('Invariant violation: "scrollViewElement != null"');}
  ...
  properties)
  {
    ...
    if (eventClass === MouseEvent) {
      const { component } = textEditorView;if (!
  ...
  describe('without line wrapping', () => {
    ...
    describe('simple case', () => {
      ...
      beforeEach(() => {
        provider = {
          providerName: 'test',
          getSuggestionForWord(sourceTextEditor, text, range) {return (0, _asyncToGenerator.default)(function* () {
        ...
        waitsForPromise((0, _asyncToGenerator.default)(function* () {
          ...
          const provider = {
            ...
            {return (0, _asyncToGenerator.default)(function* () {
                const range = [
                new _atom.Range(sourcePosition, sourcePosition.translate([0, 1])),
                new _atom.Range(
    ...
    describe('avoids excessive calls', () => {
      ...
      it('ignores <mousemove> in the same multi-range as the last suggestion', () => {
        waitsForPromise((0, _asyncToGenerator.default)(function* () {
          const range = [
          new _atom.Range(new _atom.Point(0, 1), new _atom.Point(0, 2)),
          new _atom.Range(new _atom.Point(0, 4), new _atom.Point(0, 5))];

          const callback = jasmine.createSpy('callback');
          const provider = {
            providerName: 'test',
            getSuggestion(sourceTextEditor, sourcePosition) {return (0, _asyncToGenerator.default)(function* () {
                return { range, callback };})();
            },
            priority: 0 };
      ...
      it('ignores <mousemove> when past the end of the line', () => {
        waitsForPromise((0, _asyncToGenerator.default)(function* () {
          const provider = {
            providerName: 'test',
            getSuggestion(sourceTextEditor, text) {return (0, _asyncToGenerator.default)(function* () {
                return { range: [], callback() {} };})();
            },
            priority: 0 };
    ...
    describe('hyperclick:confirm-cursor', () => {
      it('confirms the suggestion at the cursor even if the mouse moved', () => {
        waitsForPromise((0, _asyncToGenerator.default)(function* () {
          ...
          textEditor,
          'word2',
          _atom.Range.fromObject([[0, 6], [0, 11]]));

          waitsFor(function () {return callback.callCount === 1;});
        }));
      });
    });
