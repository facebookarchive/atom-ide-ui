'use strict';var _DiagnosticsMessageText;
...
function _load_DiagnosticsMessageText() {return _DiagnosticsMessageText = require('../lib/ui/DiagnosticsMessageText');}
...
describe('DiagnosticsMessageText', () => {
  ...
  it('should handle a lone URL', () => {
    expect((0, (_DiagnosticsMessageText || _load_DiagnosticsMessageText()).separateUrls)('http://example.com')).toEqual([
    { isUrl: false, text: '' },
  ...
  it('should separate URLs', () => {
    expect(
    (0, (_DiagnosticsMessageText || _load_DiagnosticsMessageText()).separateUrls)(
  ...
  it('should handle URLs at the beginning', () => {
    expect((0, (_DiagnosticsMessageText || _load_DiagnosticsMessageText()).separateUrls)('https://example.com/123 end')).toEqual([
    { isUrl: false, text: '' },
  ...
  it('should handle URLs at the end', () => {
    expect((0, (_DiagnosticsMessageText || _load_DiagnosticsMessageText()).separateUrls)('beginning https://example.com/foo.html')).toEqual([
  ...
  it('should not include trailing periods in URLs', () => {
    expect((0, (_DiagnosticsMessageText || _load_DiagnosticsMessageText()).separateUrls)('hello https://example.com/short-link.')).toEqual([
  ...
  it('should handle URLs that include escaped characters', () => {
    expect(
    (0, (_DiagnosticsMessageText || _load_DiagnosticsMessageText()).separateUrls)('https://example.com/give%20me%20some%20space/')).
    toEqual([
    { isUrl: false, text: '' },
