...
function _load_getCurrentExecutorId() {
  return _getCurrentExecutorId = _interopRequireDefault(require('../lib/getCurrentExecutorId'));
}
...
function _load_ReducersSpec() {
  return _ReducersSpec = require('./Reducers-spec');
}
...
describe('getCurrentExecutorId', () => {
  it('gets the current executor', () => {
    expect((0, (_getCurrentExecutorId || _load_getCurrentExecutorId()).default)(baseAppState)).toBe('a');
  });
