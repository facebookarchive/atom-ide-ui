...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../../../nuclide-commons/nuclideUri'));}var _CodeActionManager;

function _load_CodeActionManager() {return _CodeActionManager = require('../lib/CodeActionManager');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('CodeActionManager', () => {
  ...
  beforeEach(() => {
    ...
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      (_nuclideUri || _load_nuclideUri()).default.join(_os.default.tmpdir(), 'test.txt'));
      ...
      provider = {
        ...
        getCodeActions(_e, _r, _d) {return (0, _asyncToGenerator.default)(function* () {
            return [];})();
        } };
  ...
  it('finds code actions on highlight change and updates linter', () => {
    ...
    {
      apply() {},
      getTitle() {return (0, _asyncToGenerator.default)(function* () {
          return 'Mock action';})();
      },
      dispose() {} }];
    ...
    runs(() => {
      ...
      expect(
      spyLinter.mostRecentCall.args[0][0].solutions.length).
      toEqual(1);
    });
  });
}); /**
