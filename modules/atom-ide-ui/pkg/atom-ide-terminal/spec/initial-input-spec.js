...
function _load_terminalView() {return _terminalView = require('../lib/terminal-view');}
...
describe('initial input sanitizer', () => {
  ...
  it('rejects inputs with potentially malicious characters', () => {
    expect(
    (0, (_terminalView || _load_terminalView()).getSafeInitialInput)(
