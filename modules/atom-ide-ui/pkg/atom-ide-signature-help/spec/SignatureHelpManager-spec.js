...
var _atom = require('atom');var _testHelpers;
function _load_testHelpers() {return _testHelpers = require('../../../../nuclide-commons-atom/test-helpers');}var _promise;
function _load_promise() {return _promise = require('../../../../nuclide-commons/promise');}var _UniversalDisposable;
function _load_UniversalDisposable() {return _UniversalDisposable = _interopRequireDefault(require('../../../../nuclide-commons/UniversalDisposable'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                       *  strict-local
                                                                                                                                                                                                                                                       * @format
                                                                                                                                                                                                                                                       */describe('SignatureHelpManager', () => {let disposable;let testProvider;let mockDatatipService;let editor;beforeEach(() => {waitsForPromise((0, _asyncToGenerator.default)(function* () {(0, (_testHelpers || _load_testHelpers()).jasmineAttachWorkspace)();
