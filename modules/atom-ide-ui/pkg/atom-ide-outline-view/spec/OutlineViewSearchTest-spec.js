...
function _load_OutlineViewSearch() {
  return _OutlineViewSearch = require('../lib/OutlineViewSearch');
}
...
const sampleOutlineView = [{
  tokenizedText: [{ kind: 'keyword', value: 'const' }, { kind: 'whitespace', value: ' ' }, { kind: 'param', value: 'logger' }],
  startPosition: new _atom.Point(35, 0),
  endPosition: new _atom.Point(35, 49),
  highlighted: false,
  children: []
}, {
  tokenizedText: [{ kind: 'keyword', value: 'const' }, { kind: 'whitespace', value: ' ' }, { kind: 'param', value: 'SEARCH_ENABLED_DEFAULT' }],
  startPosition: new _atom.Point(36, 0),
  endPosition: new _atom.Point(36, 36),
  highlighted: false,
  children: []
}, {
  tokenizedText: [{ kind: 'keyword', value: 'export' }, { kind: 'whitespace', value: ' ' }, { kind: 'keyword', value: 'class' }, { kind: 'whitespace', value: ' ' }, { kind: 'class-name', value: 'OutlineView' }],
  startPosition: new _atom.Point(59, 0),
  endPosition: new _atom.Point(144, 1),
  highlighted: false,
  children: [{
    tokenizedText: [{ kind: 'method', value: 'state' }, { kind: 'plain', value: '=' }],
    startPosition: new _atom.Point(60, 2),
    endPosition: new _atom.Point(60, 15),
    highlighted: false,
    children: []
  }, {
    tokenizedText: [{ kind: 'method', value: 'props' }, { kind: 'plain', value: '=' }],
    startPosition: new _atom.Point(61, 2),
    endPosition: new _atom.Point(61, 15),
    highlighted: false,
    children: []
  }, {
    tokenizedText: [{ kind: 'method', value: 'subscription' }, { kind: 'plain', value: '=' }],
    startPosition: new _atom.Point(63, 2),
    endPosition: new _atom.Point(63, 36),
    highlighted: false,
    children: []
  }, {
    tokenizedText: [{ kind: 'method', value: 'constructor' }, { kind: 'plain', value: '(' }, { kind: 'param', value: 'props' }, { kind: 'plain', value: ')' }],
    startPosition: new _atom.Point(65, 2),
    endPosition: new _atom.Point(76, 3),
    highlighted: false,
    children: []
  }, {
    tokenizedText: [{ kind: 'method', value: 'componentDidMount' }, { kind: 'plain', value: '(' }, { kind: 'plain', value: ')' }],
  ...
  tokenizedText: [{ kind: 'keyword', value: 'class' }, { kind: 'whitespace', value: ' ' }, { kind: 'class-name', value: 'OutlineViewComponent' }],
...
describe('OutlineViewSearchTest', () => {
  it('Map is filled for all elements', () => {
    ...
    sampleOutlineView.forEach(root => (0, (_OutlineViewSearch || _load_OutlineViewSearch()).updateSearchSet)('query', root, resultsMap, new Map(), ''));
  ...
  it('Prefix matching for results', () => {
    const resultsMap = new Map();
    sampleOutlineView.forEach(root => (0, (_OutlineViewSearch || _load_OutlineViewSearch()).updateSearchSet)('logge', root, resultsMap, new Map(), ''));
  ...
  it('Fuzzy search for results', () => {
    const resultsMap = new Map();
    sampleOutlineView.forEach(root => (0, (_OutlineViewSearch || _load_OutlineViewSearch()).updateSearchSet)('cdm', root, resultsMap, new Map(), ''));
  ...
  it('Child does not need to be visible when parent is', () => {
    const resultsMap = new Map();
    sampleOutlineView.forEach(root => (0, (_OutlineViewSearch || _load_OutlineViewSearch()).updateSearchSet)('OutlineView', root, resultsMap, new Map(), ''));
  ...
  it('Keywords are included in the search', () => {
    const resultsMap = new Map();
    sampleOutlineView.forEach(root => (0, (_OutlineViewSearch || _load_OutlineViewSearch()).updateSearchSet)('const', root, resultsMap, new Map(), ''));
  ...
  it('Previous query optimization maintains functionality', () => {
    ...
    sampleOutlineView.forEach(root => (0, (_OutlineViewSearch || _load_OutlineViewSearch()).updateSearchSet)('logge', root, resultsMap, resultsMap, 'logger'));
