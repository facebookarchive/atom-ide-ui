...
describe('getDefinitionPreview', () => {
  describe('Constant symbols', () => {
    it('returns the only line of a one-line symbol', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const preview = yield (0, (_symbolDefinitionPreview || _load_symbolDefinitionPreview()).getDefinitionPreview)(javascriptFixtureDefinitionWithPoint(new (_simpleTextBuffer || _load_simpleTextBuffer()).Point(11, 6)));
    ...
    it('returns the entire multi-line symbol', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const preview = yield (0, (_symbolDefinitionPreview || _load_symbolDefinitionPreview()).getDefinitionPreview)(javascriptFixtureDefinitionWithPoint(new (_simpleTextBuffer || _load_simpleTextBuffer()).Point(15, 6)));
  ...
  describe('Type symbols', () => {
    it('returns an entire multi-line type', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const preview = yield (0, (_symbolDefinitionPreview || _load_symbolDefinitionPreview()).getDefinitionPreview)(javascriptFixtureDefinitionWithPoint(new (_simpleTextBuffer || _load_simpleTextBuffer()).Point(21, 5)));
    ...
    it('returns only the property from within a type', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const preview = yield (0, (_symbolDefinitionPreview || _load_symbolDefinitionPreview()).getDefinitionPreview)(javascriptFixtureDefinitionWithPoint(new (_simpleTextBuffer || _load_simpleTextBuffer()).Point(44, 4)));
    ...
    it('returns property and value of a complex type within a type', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const preview = yield (0, (_symbolDefinitionPreview || _load_symbolDefinitionPreview()).getDefinitionPreview)(javascriptFixtureDefinitionWithPoint(new (_simpleTextBuffer || _load_simpleTextBuffer()).Point(43, 2)));
  ...
  describe('Function symbols', () => {
    it('returns just one line if parens are balanced on the first line', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const preview = yield (0, (_symbolDefinitionPreview || _load_symbolDefinitionPreview()).getDefinitionPreview)(javascriptFixtureDefinitionWithPoint(new (_simpleTextBuffer || _load_simpleTextBuffer()).Point(26, 16)));
    ...
    it('works without parentheses as with python', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const preview = yield (0, (_symbolDefinitionPreview || _load_symbolDefinitionPreview()).getDefinitionPreview)(pythonFixtureDefinitionWithPoint(new (_simpleTextBuffer || _load_simpleTextBuffer()).Point(7, 4)));
    ...
    it('works without parentheses but with braces as with python', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const preview = yield (0, (_symbolDefinitionPreview || _load_symbolDefinitionPreview()).getDefinitionPreview)(pythonFixtureDefinitionWithPoint(new (_simpleTextBuffer || _load_simpleTextBuffer()).Point(11, 4)));
    ...
    it("doesn't dedent beyond the current lines indentation level", () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const preview = yield (0, (_symbolDefinitionPreview || _load_symbolDefinitionPreview()).getDefinitionPreview)(javascriptFixtureDefinitionWithPoint(new (_simpleTextBuffer || _load_simpleTextBuffer()).Point(36, 18)));
    ...
    it('reads until the indentation returns to initial and parens are balanced', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const preview = yield (0, (_symbolDefinitionPreview || _load_symbolDefinitionPreview()).getDefinitionPreview)(javascriptFixtureDefinitionWithPoint(new (_simpleTextBuffer || _load_simpleTextBuffer()).Point(30, 16)));
