...
describe('fsPromise test suite', () => {
  ...
  describe('writeFileAtomic', () => {
    ...
    it('can write to a file', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        yield (_fsPromise || _load_fsPromise()).default.writeFileAtomic(pathToWriteFile, "I'm a little teapot.\n");
        expect(_fs.default.readFileSync(pathToWriteFile).toString()).toEqual("I'm a little teapot.\n");
        // eslint-disable-next-line no-bitwise
        expect(_fs.default.statSync(pathToWriteFile).mode & 0o777).toEqual(0o644);
      }));
    });
    ...
    it('returns 500 if file cannot be written', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        let err;
        try {
          yield (_fsPromise || _load_fsPromise()).default.writeFileAtomic(pathToWriteFile + '/that/is/missing/', 'something');
        } catch (e) {
          err = e;
        }
