'use strict';var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));let captureParallelismHistory = (() => {var _ref34 = (0, _asyncToGenerator.default)(
  ...
  args)
  {
    ...
    ...args.map(function (arg) {
      ...
      const func = arg;
      return (() => {var _ref35 = (0, _asyncToGenerator.default)(function* (item) {
          ++parralelism;
          parallelismHistory.push(parralelism);
          const value = yield func(item);
          --parralelism;
          return value;
        });return function (_x4) {return _ref35.apply(this, arguments);};})();
    }));
