...
function _load_string() {return _string = require('../string');}
...
describe('relativeDate', () => {
  it('works', () => {
    ...
    expect((0, (_string || _load_string()).relativeDate)(reference - 41 * SECOND, reference)).toEqual(
    'just now');

    expect((0, (_string || _load_string()).relativeDate)(reference - 42 * SECOND, reference)).toEqual(
    'a minute ago');

    expect((0, (_string || _load_string()).relativeDate)(reference - MINUTE, reference)).toEqual('a minute ago');
    expect((0, (_string || _load_string()).relativeDate)(reference - MINUTE * 1.5, reference)).toEqual(
    '2 minutes ago');

    expect((0, (_string || _load_string()).relativeDate)(reference - MINUTE * 59, reference)).toEqual(
    '59 minutes ago');

    expect((0, (_string || _load_string()).relativeDate)(reference - HOUR, reference)).toEqual('an hour ago');
    expect((0, (_string || _load_string()).relativeDate)(reference - HOUR * 1.5, reference)).toEqual(
    '2 hours ago');

    expect((0, (_string || _load_string()).relativeDate)(reference - HOUR * 16, reference)).toEqual(
    '16 hours ago');

    expect((0, (_string || _load_string()).relativeDate)(reference - HOUR * 23, reference)).toEqual(
    '23 hours ago');
    ...
    expect((0, (_string || _load_string()).relativeDate)(reference - WEEK * 2, reference)).toEqual(
    '2 weeks ago');

    expect((0, (_string || _load_string()).relativeDate)(reference - WEEK * 4, reference)).toEqual(
    '4 weeks ago');

    expect((0, (_string || _load_string()).relativeDate)(reference - MONTH * 1.2, reference)).toEqual(
    'a month ago');

    expect((0, (_string || _load_string()).relativeDate)(reference - YEAR + HOUR, reference)).toEqual(
    '12 months ago');

    expect((0, (_string || _load_string()).relativeDate)(reference - YEAR, reference)).toEqual('a year ago');
    expect((0, (_string || _load_string()).relativeDate)(reference - YEAR * 2, reference)).toEqual(
    '2 years ago');

    expect((0, (_string || _load_string()).relativeDate)(0, reference)).toEqual('5 years ago');

    // test short format
    expect((0, (_string || _load_string()).relativeDate)(0, undefined, /* short */true)).toEqual(
    Math.round(now / YEAR) + 'y');

    expect(
    (0, (_string || _load_string()).relativeDate)(reference * SECOND, reference, /* short */true)).
    toEqual('now');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - 41 * SECOND, reference, /* short */true)).
    toEqual('now');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - 42 * SECOND, reference, /* short */true)).
    toEqual('1m');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - MINUTE, reference, /* short */true)).
    toEqual('1m');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - MINUTE * 1.5, reference, /* short */true)).
    toEqual('2m');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - MINUTE * 59, reference, /* short */true)).
    toEqual('59m');
    expect((0, (_string || _load_string()).relativeDate)(reference - HOUR, reference, /* short */true)).toEqual(
    '1h');

    expect(
    (0, (_string || _load_string()).relativeDate)(reference - HOUR * 1.5, reference, /* short */true)).
    toEqual('2h');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - HOUR * 16, reference, /* short */true)).
    toEqual('16h');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - HOUR * 23, reference, /* short */true)).
    toEqual('23h');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - DAY * 1.8, reference, /* short */true)).
    toEqual('1d');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - DAY * 3, reference, /* short */true)).
    toEqual('3d');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - DAY * 6, reference, /* short */true)).
    toEqual('6d');
    expect((0, (_string || _load_string()).relativeDate)(reference - WEEK, reference, /* short */true)).toEqual(
    '1w');

    expect(
    (0, (_string || _load_string()).relativeDate)(reference - WEEK * 2, reference, /* short */true)).
    toEqual('2w');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - WEEK * 4, reference, /* short */true)).
    toEqual('4w');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - MONTH * 1.2, reference, /* short */true)).
    toEqual('1mo');
    expect(
    (0, (_string || _load_string()).relativeDate)(reference - YEAR + HOUR, reference, /* short */true)).
    toEqual('12mo');
    expect((0, (_string || _load_string()).relativeDate)(reference - YEAR, reference, /* short */true)).toEqual(
    '1y');

    expect(
    (0, (_string || _load_string()).relativeDate)(reference - YEAR * 2, reference, /* short */true)).
    toEqual('2y');
     ...
     * 
     * @format
     */describe('maybeToString', () => {it("returns 'undefined'", () => {expect((0, (_string || _load_string()).maybeToString)(undefined)).toEqual('undefined');});it("returns 'null'", () => {expect((0, (_string || _load_string()).maybeToString)(null)).toEqual('null');});
...
describe('getMatchRanges', () => {
  it('works', () => {
    expect((0, (_string || _load_string()).getMatchRanges)('test1test2test3', 'test')).toEqual([
    [0, 4],
    [5, 9],
    [10, 14]]);

    expect((0, (_string || _load_string()).getMatchRanges)('ttttttt', 'ttt')).toEqual([[0, 6]]);
    expect((0, (_string || _load_string()).getMatchRanges)('test1test2test3', 'none')).toEqual([]);
    expect((0, (_string || _load_string()).getMatchRanges)('test1test2test3', '')).toEqual([]);
  });
});