...
function _load_testHelpers() {return _testHelpers = require('../test-helpers');}
...
describe('nice', () => {
  ...
  beforeEach(() => {
    ...
    whichSpy = spyOn(require('../which'), 'default').andCallFake((() => {var _ref = (0, _asyncToGenerator.default)(
      function* (command) {
        if (
    ...
    _rxjsBundlesRxMinJs.Observable.of(fakeSafeSpawnReturn));
