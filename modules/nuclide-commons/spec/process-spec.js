...
function _load_promise() {return _promise = require('../promise');}
var _child_process = _interopRequireDefault(require('child_process'));

var _rxjsBundlesRxMinJs = require('rxjs/bundles/Rx.min.js');var _process;
...
describe('commons-node/process', () => {
  ...
  describe('process.killProcess', () => {
    ...
    it('should kill the process tree when `killTree` is true', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        const proc = _child_process.default.spawn('bash', [
        '-c',
    ...
    it('should kill the process tree on windows when `killTree` is true', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        expect(_child_process.default.exec.calls[0].args[0]).toBe(
  ...
  describe('getOutputStream', () => {
    ...
    it('errors on nonzero exit codes by default', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        toArray().
        toPromise();
        expect(results.map(function (notification) {return notification.kind;})).toEqual([
        'N',
        'N',
        'E']);
      ...
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        try {
          yield (0, (_process || _load_process()).getOutputStream)(child, {
            ...
            isExitError: function () {return true;} }).
        ...
        expect(error).toBeDefined();if (!(
        error != null)) {throw new Error('Invariant violation: "error != null"');}
  ...
  describe('spawn', () => {
    it('errors when the process does', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        expect(error).toBeDefined();if (!
        error) {throw new Error('Invariant violation: "error"');}
    ...
    it('errors before emitting the process', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        spyOn(console, 'log'); // suppress log printing
        let proc;
        yield (0, (_process || _load_process()).spawn)('fakeCommand').
        do(function (p) {
          proc = p;
        }).
        catch(function (err) {
    ...
    it('can be retried', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        try {
          yield (0, (_process || _load_process()).spawn)('fakeCommand').
          retryWhen(function (errors) {return (
    ...
    it('can be timed out', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        let proc;
        try {
          yield (0, (_process || _load_process()).spawn)('sleep', ['10000'], { timeout: 1 }).
          do(function (p) {
            proc = p;
            spyOn(proc, 'kill');
          }).
        ...
        proc != null)) {throw new Error('Invariant violation: "proc != null"');}if (!(
        error != null)) {throw new Error('Invariant violation: "error != null"');}
  ...
  describe('observeProcess', () => {
    ...
    it('errors on nonzero exit codes by default', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const results = yield (0, (_process || _load_process()).observeProcess)(process.execPath, [
        '-e',
        'console.error("stderr"); console.log("std out"); process.exit(42);'])
    ...
    it('accumulates the first `exitErrorBufferSize` bytes of stderr for the exit error', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        let error;
        try {
          yield (0, (_process || _load_process()).observeProcess)(
          process.execPath,
          ['-e', 'console.error("stderr"); process.exit(42);'],
          { exitErrorBufferSize: 2, isExitError: function () {return true;} }).
  ...
  describe('observeProcessRaw', () => {
    it("doesn't split on line breaks", () => {
      ...
      waitsForPromise({ timeout: 1000 }, (0, _asyncToGenerator.default)(function* () {
        const event = yield (0, (_process || _load_process()).observeProcessRaw)(process.execPath, [
        '-e',
        'process.stdout.write("stdout1\\nstdout2\\n"); process.exit(1)']).

        take(1).
        toPromise();if (!(
        event.kind === 'stdout')) {throw new Error('Invariant violation: "event.kind === \'stdout\'"');}
  ...
  describe('runCommand', () => {
    ...
    it('throws an error if the exit code !== 0', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        let error;
        try {
          yield (0, (_process || _load_process()).runCommand)(process.execPath, [
          '-e',
          'process.exit(1)']).
          toPromise();
        } catch (err) {
    ...
    it("doesn't share a mutable seed (regression test)", () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const observable = (0, (_process || _load_process()).runCommand)(process.execPath, [
        '-e',
  ...
  describe('runCommandDetailed', () => {
    ...
    it('returns stdout, stderr, and the exit code of the running process', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const val = yield (0, (_process || _load_process()).runCommandDetailed)(process.execPath, [
        '-e',
    ...
    it('throws an error if the exit code !== 0', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        let error;
        try {
          yield (0, (_process || _load_process()).runCommandDetailed)(process.execPath, [
          '-e',
          'process.exit(1)']).
          toPromise();
        } catch (err) {
  ...
  describe('exitEventToMessage', () => {
    ...
    it('signal', () => {
      expect(
      (0, (_process || _load_process()).exitEventToMessage)({ kind: 'exit', exitCode: null, signal: 'SIGTERM' })).
      toBe('signal SIGTERM');
    });
  });
  ...
  describe('scriptifyCommand', () => {
    if (process.platform === 'linux') {
      it('escapes correctly on linux', () => {
        waitsForPromise((0, _asyncToGenerator.default)(function* () {
          const output = yield (0, (_process || _load_process()).runCommand)(
          ...(0, (_process || _load_process()).scriptifyCommand)('echo', [
     ...
     * 
     * @format
     */function makeExitMessage(exitCode) {return { kind: 'exit', exitCode, signal: null };}