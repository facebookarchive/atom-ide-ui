...
function _load_shellQuote() {return _shellQuote = require('../_shell-quote');}
...
describe('shell-quote', () => {
  describe('parse', () => {
    it('parses comments correctly', () => {
      ...
      expect((0, (_shellQuote || _load_shellQuote()).parse)('beep > boop # > foo')).toEqual([
      'beep',
      { op: '>' },
      'boop',
      { comment: '> foo' }]);
