'use strict';var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _ContextMenu;
...
function _load_ContextMenu() {return _ContextMenu = _interopRequireDefault(require('../ContextMenu'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('ContextMenu', () => {
  ...
  afterEach(() => {
    ...
    if (div != null) {if (!(
      div.parentNode != null)) {throw new Error('Invariant violation: "div.parentNode != null"');}
