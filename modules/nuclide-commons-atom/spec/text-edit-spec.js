...
var _atom = require('atom');var _textEdit;

function _load_textEdit() {return _textEdit = require('../text-edit');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                      ...
                                                                                                                                                                      * 
                                                                                                                                                                      * @format
                                                                                                                                                                      */const fakeFile = '/tmp/file.txt';describe('applyTextEdits', () => {let editor = null;beforeEach(() => {waitsForPromise((0, _asyncToGenerator.default)(function* () {editor = yield atom.workspace.open(fakeFile);editor.setText('foo\nbar\nbaz\n');
    }));
  });
