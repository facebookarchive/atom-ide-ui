...
function _load_goToLocation() {return _goToLocation = require('../go-to-location');}var _testHelpers;
function _load_testHelpers() {return _testHelpers = require('../test-helpers');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                               ...
                                                                                                                                                                               * 
                                                                                                                                                                               * @format
                                                                                                                                                                               */const FILE1_PATH = (_nuclideUri || _load_nuclideUri()).default.join(__dirname, 'fixtures/file1.txt');const FILE2_PATH = (_nuclideUri || _load_nuclideUri()).default.join(__dirname, 'fixtures/file2.txt');describe('goToLocation', () => {beforeEach(() => {(0, (_testHelpers || _load_testHelpers()).jasmineAttachWorkspace)();atom.workspace.getTextEditors().forEach(editor => {editor.destroy();});
  });

  it('should work with nothing open', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      const editor = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
  ...
  it('should open the current file successfully', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      const editor1 = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
      const editor2 = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
  ...
  it('should re-use the editor for an already-open file', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      const editor1 = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
      const editor2 = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE2_PATH);
      expect(atom.workspace.getActiveTextEditor()).toBe(editor2);

      const editor3 = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
  ...
  it('should search other panes for an editor for this file', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      const editor1 = yield atom.workspace.open(FILE1_PATH);
      const editor2 = yield atom.workspace.open(FILE2_PATH, { split: 'right' });
      expect(atom.workspace.getActiveTextEditor()).toBe(editor2);
  ...
  it('should correctly set the cursor position when opening a file', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      const editor = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 3 });
  ...
  it('should correctly set the cursor position when opening an already-open file', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      const editor2 = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 3 });
  ...
  it('focuses the editor', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      const editor2 = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 0, column: 0 });
      expect(editor2).toBe(editor1);
  ...
  describe('its effect on observeNavigatingEditors', () => {
    ...
    beforeEach(() => {
      ...
      subscription = (0, (_goToLocation || _load_goToLocation()).observeNavigatingEditors)().subscribe(editor => {
    ...
    it('should not publish when opening a new file', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 2 });
    ...
    it('should not publish when opening the current editor with no position', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
        yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
        expect(navigatingEditorsArray).toEqual([]);
      }));
    });
    ...
    it('should publish when opening the current file with a position', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        const editor1 = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 2 });
        expect(navigatingEditorsArray).toEqual([]);
        const editor2 = yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 2 });
        expect(editor2).toBe(editor1);
    ...
    it('should not publish when opening a file that is already open but not focused', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 2 });
        yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE2_PATH, { line: 1, column: 2 });
        yield (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 2 });
        expect(navigatingEditorsArray).toEqual([]);
      }));
    });
