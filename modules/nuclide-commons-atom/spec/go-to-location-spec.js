...
describe('goToLocation', () => {
  ...
  it('should work with nothing open', () => {
    waitsForPromise(async () => {
      const editor = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
  ...
  it('should open the current file successfully', () => {
    waitsForPromise(async () => {
      const editor1 = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
      const editor2 = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
  ...
  it('should re-use the editor for an already-open file', () => {
    waitsForPromise(async () => {
      const editor1 = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
      const editor2 = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE2_PATH);
      expect(atom.workspace.getActiveTextEditor()).toBe(editor2);

      const editor3 = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
  ...
  it('should correctly set the cursor position when opening a file', () => {
    waitsForPromise(async () => {
      const editor = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 3 });
  ...
  it('should correctly set the cursor position when opening an already-open file', () => {
    waitsForPromise(async () => {
      ...
      const editor2 = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 3 });
  ...
  it('focuses the editor', () => {
    waitsForPromise(async () => {
      ...
      const editor2 = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 0, column: 0 });
      expect(editor2).toBe(editor1);
  ...
  describe('its effect on observeNavigatingEditors', () => {
    ...
    it('should not publish when opening a new file', () => {
      waitsForPromise(async () => {
        await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 2 });
    ...
    it('should not publish when opening the current editor with no position', () => {
      waitsForPromise(async () => {
        await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
        await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH);
        expect(navigatingEditorsArray).toEqual([]);
      });
    });
    ...
    it('should publish when opening the current file with a position', () => {
      waitsForPromise(async () => {
        const editor1 = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 2 });
        expect(navigatingEditorsArray).toEqual([]);
        const editor2 = await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 2 });
        expect(editor2).toBe(editor1);
    ...
    it('should not publish when opening a file that is already open but not focused', () => {
      waitsForPromise(async () => {
        await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 2 });
        await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE2_PATH, { line: 1, column: 2 });
        await (0, (_goToLocation || _load_goToLocation()).goToLocation)(FILE1_PATH, { line: 1, column: 2 });
        expect(navigatingEditorsArray).toEqual([]);
      });
    });
