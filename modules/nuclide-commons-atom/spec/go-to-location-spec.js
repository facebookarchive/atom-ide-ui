...
const FILE1_PATH = (_nuclideUri || _load_nuclideUri()).default.join(__dirname, 'fixtures/file1.txt');
const FILE2_PATH = (_nuclideUri || _load_nuclideUri()).default.join(__dirname, 'fixtures/file2.txt');
