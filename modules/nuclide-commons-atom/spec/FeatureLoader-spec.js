...
function _load_idx() {return _idx = _interopRequireDefault(require('idx'));}
var _fs = _interopRequireDefault(require('fs'));

var _path = _interopRequireDefault(require('path'));var _FeatureLoader;

function _load_FeatureLoader() {return _FeatureLoader = _interopRequireDefault(require('../FeatureLoader'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // eslint-disable-next-line rulesdir/prefer-nuclide-uri
/**
 ...
 * 
 * @format
 */const FEATURE_PACKAGE_PATH = _path.default.join(__dirname, 'fixtures', 'feature-package');const ALWAYS_ENABLED = 'always';const NEVER_ENABLED = 'never';const DEFAULT = 'default';
const featurePkg = JSON.parse(
_fs.default.readFileSync(_path.default.join(FEATURE_PACKAGE_PATH, 'package.json')).toString());

const featureName = _path.default.basename(FEATURE_PACKAGE_PATH);

const ROOT_PACKAGE_DIRNAME = 'root-package';
const ROOT_PACKAGE_PATH = _path.default.join(
__dirname,
'fixtures',
...
describe('FeatureLoader', () => {
  ...
  describe('load', () => {
    ...
    it('sets a description including provided and consumed services', () => {var _ref, _ref2, _ref3, _ref4;
      expect((_ref =
      loader.getConfig()) != null ? (_ref2 = _ref.use) != null ? (_ref3 = _ref2.properties) != null ? (_ref4 = _ref3[featureName]) != null ? _ref4.description : _ref4 : _ref3 : _ref2 : _ref).
      toEqual(
      'Hyperclick UI<br/>**Provides:** _hyperclick.observeTextEditor_<br/>**Consumes:** _hyperclick_');

    });

    it("merges the feature config into the passed config's feature properties", () => {var _ref5, _ref6;
      expect((_ref5 = loader.getConfig()) != null ? (_ref6 = _ref5[featureName]) != null ? _ref6.properties : _ref6 : _ref5).toEqual(
