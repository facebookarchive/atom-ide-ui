...
function _load_FeatureLoader() {return _FeatureLoader = _interopRequireDefault(require('../FeatureLoader'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // eslint-disable-next-line nuclide-internal/prefer-nuclide-uri
/**
 ...
 *  strict-local
 * @format
 */const FEATURE_PACKAGE_PATH = _path.default.join(__dirname, 'fixtures', 'feature-package');const ALWAYS_ENABLED = 'always';const featurePkg = JSON.parse(_fs.default.readFileSync(_path.default.join(FEATURE_PACKAGE_PATH, 'package.json')).toString());
