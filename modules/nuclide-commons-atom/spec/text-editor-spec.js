'use strict';var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _textEditor;
...
function _load_textEditor() {return _textEditor = require('../text-editor');}
...
var _atom = require('atom');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                           ...
                                                                                                                           * 
                                                                                                                           * @format
                                                                                                                           */describe('existingEditorForUri', () => {const file1 = '/tmp/file1.txt';const file2 = '/tmp/file2.txt';const file3 = '/tmp/file3.txt';let file1Editor = null;let file2Editor = null;let secondFile2Editor = null;
  beforeEach(() => {
...
describe('observeTextEditors', () => {
  it('should ignore broken remote paths', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      const paths = [];
      (0, (_textEditor || _load_textEditor()).observeTextEditors)(function (editor) {return paths.push(editor.getPath());});
...
describe('enforceReadOnlyEditor', () => {
  ...
  it('should not be able to write to the text editor', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      buffer,
      [function () {return buffer.setText('lol');}, function () {return buffer.append('lol');}],
      false);
...
describe('enforceReadOnlyBuffer', () => {
  function getOperations(buffer) {
    ...
    () => buffer.delete(new _atom.Range([0, 0], [1, 0])),
    () => buffer.insert(new _atom.Point(0, 0), 'lol'),
    () => buffer.undo(),
    () => buffer.setText('lol')];
