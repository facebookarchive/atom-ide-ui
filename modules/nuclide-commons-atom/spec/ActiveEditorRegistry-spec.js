...
describe('ActiveEditorRegistry', () => {
  ...
  beforeEach(() => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      eventSources = {
        activeEditors,
        changesForEditor: function () {
          return editorChanges;
        },
        savesForEditor: function () {
          return editorSaves;
        }
      };
  ...
  describe('when there is a provider', () => {
    ...
    it('should create correct event stream during normal use', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        yield (0, (_testHelpers || _load_testHelpers()).expectObservableToStartWith)(eventNames, ['not-text-editor', 'pane-change', 'result', 'edit', 'result', 'pane-change', 'result']);

        const fullEvents = yield events.take(4).toArray().toPromise();
    ...
    it('should not emit save events when it is configured to respond to edit events', () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        yield (0, (_testHelpers || _load_testHelpers()).expectObservableToStartWith)(eventNames, ['pane-change', 'result', 'edit', 'result']);
      }));
    });
    ...
    describe('when configured to respond to save events', () => {
      ...
      it('should generate and respond to save events', () => {
        waitsForPromise((0, _asyncToGenerator.default)(function* () {
          ...
          yield (0, (_testHelpers || _load_testHelpers()).expectObservableToStartWith)(eventNames, ['pane-change', 'result', 'save', 'result']);

          const fullEvents = yield events.take(3).toArray().toPromise();
          expect(fullEvents[2]).toEqual({
            kind: 'save',
            editor: editor1
          });
    ...
    describe('when given providers with different updateOnEdit settings', () => {
      ...
      it('should generate and respond to the appropriate event', () => {
        waitsForPromise((0, _asyncToGenerator.default)(function* () {
          ...
          yield (0, (_testHelpers || _load_testHelpers()).expectObservableToStartWith)(eventNames, ['pane-change', 'result', 'edit', 'result', 'pane-change', 'result', 'save', 'result']);
        }));
      });
    });
    ...
    it("should produce the 'provider-error' event when a provider errors", () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        yield (0, (_testHelpers || _load_testHelpers()).expectObservableToStartWith)(eventNames, ['pane-change', 'provider-error']);
  ...
  describe('when there is no provider', () => {
    it("should produce the 'no-provider' result when there is no provider", () => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        ...
        yield (0, (_testHelpers || _load_testHelpers()).expectObservableToStartWith)(eventNames, ['pane-change', 'no-provider']);
      }));
    });
  });
}); /**
