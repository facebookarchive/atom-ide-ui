...
function _load_nuclideUri() {return _nuclideUri = _interopRequireDefault(require('../../nuclide-commons/nuclideUri'));}var _projects;
function _load_projects() {return _projects = require('../projects');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                     ...
                                                                                                                                                                     * 
                                                                                                                                                                     * @format
                                                                                                                                                                     */describe('projects', () => {let firstProjectPath = null;let otherProjectPath = null;
  beforeEach(() => {
  ...
  describe('getFileForPath', () => {
    it('works for paths both above and below the project path', () => {
      ...
      const file1 = (0, (_projects || _load_projects()).getFileForPath)(path1);if (!(
      file1 != null)) {throw new Error('Invariant violation: "file1 != null"');}
      expect(file1.getPath()).toBe(path1);

      const path2 = (_nuclideUri || _load_nuclideUri()).default.join(firstProjectPath, 'child/path');
      const file2 = (0, (_projects || _load_projects()).getFileForPath)(path2);if (!(
      file2 != null)) {throw new Error('Invariant violation: "file2 != null"');}
