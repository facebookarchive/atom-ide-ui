...
const _adapters = new Map([['node', {
  ...
  root: (_nuclideUri || _load_nuclideUri()).default.join(resolvePackagePath('atom-ide-debugger-node'), 'VendorLib/vscode-node-debug2')
}], ['python', {
  executable: {
    command: 'node',
  ...
  root: (_nuclideUri || _load_nuclideUri()).default.join(resolvePackagePath('atom-ide-debugger-python'), 'VendorLib/vs-py-debugger')
}], ['react-native', {
  executable: {
    command: 'node',
  ...
  root: (_nuclideUri || _load_nuclideUri()).default.join(resolvePackagePath('atom-ide-debugger-teact-native'), 'VendorLib/vscode-react-native')
}], ['prepack', {
  executable: {
    command: 'node',
