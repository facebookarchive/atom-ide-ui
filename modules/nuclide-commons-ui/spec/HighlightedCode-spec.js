...
function _load_dedent() {return _dedent = _interopRequireDefault(require('dedent'));}var _nullthrows;
function _load_nullthrows() {return _nullthrows = _interopRequireDefault(require('nullthrows'));}
var _react = _interopRequireWildcard(require('react'));
var _reactDom = _interopRequireDefault(require('react-dom'));var _HighlightedCode;
...
describe('highlightCode', () => {
  ...
  it('is able to tokenize lines using a grammar', () => {
    const tokens = (0, (_HighlightedCode || _load_HighlightedCode()).highlightCode)(
    grammar,
  ...
  it('becomes HTML using highlightCodeHtml', () => {
    ...
    _react.createElement((_HighlightedCode || _load_HighlightedCode()).HighlightedCode, { grammar: grammar, code: '#Heading' }),
    node);
