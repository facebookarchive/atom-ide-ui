'use strict';var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _openPreview;
...
function _load_openPreview() {return _openPreview = _interopRequireDefault(require('../openPreview'));}var _fsPromise;
function _load_fsPromise() {return _fsPromise = _interopRequireDefault(require('nuclide-commons/fsPromise'));}var _nullthrows;
...
describe('openPreview', () => {
  ...
  describe('opening a preview of a different file', () => {
    ...
    beforeEach(() => {
      waitsForPromise((0, _asyncToGenerator.default)(function* () {
        [startingFile, previewingFile] = yield Promise.all([
        (_fsPromise || _load_fsPromise()).default.tempfile(),
        (_fsPromise || _load_fsPromise()).default.tempfile()]);
    ...
    afterEach(() => {
      waitsForPromise(() =>
      Promise.all([
      (_fsPromise || _load_fsPromise()).default.unlink(startingFile),
      (_fsPromise || _load_fsPromise()).default.unlink(previewingFile)]));
  ...
  describe('with multiple previews', () => {
    ...
    afterEach(() => {
      ...
      Promise.all([
      (_fsPromise || _load_fsPromise()).default.unlink(startingFile),
      (_fsPromise || _load_fsPromise()).default.unlink(firstPreviewingFile),
      (_fsPromise || _load_fsPromise()).default.unlink(secondPreviewingFile)]));
  ...
  it('never reuses a non-pending pane', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      const [startingFile, file1, file2] = yield Promise.all([
      (_fsPromise || _load_fsPromise()).default.tempfile(),
      (_fsPromise || _load_fsPromise()).default.tempfile(),
      (_fsPromise || _load_fsPromise()).default.tempfile()]);
      ...
      yield Promise.all([
      (_fsPromise || _load_fsPromise()).default.unlink(startingFile),
      (_fsPromise || _load_fsPromise()).default.unlink(file1),
      (_fsPromise || _load_fsPromise()).default.unlink(file2)]);
  ...
  it('throws when trying to confirm a preview that is not the latest', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      const [file1, file2] = yield Promise.all([
      (_fsPromise || _load_fsPromise()).default.tempfile(),
      (_fsPromise || _load_fsPromise()).default.tempfile()]);
  ...
  it('throws when calling cancel after confirm', () => {
    waitsForPromise((0, _asyncToGenerator.default)(function* () {
      ...
      const preview = (0, (_openPreview || _load_openPreview()).default)(file);
      preview.confirm();
      expect(function () {return preview.cancel();}).toThrow();
     ...
     * 
     * @format
     */function getActiveTextEditor() {return (0, (_nullthrows || _load_nullthrows()).default)(atom.workspace.getActiveTextEditor());}function getPendingItem() {return (0, (_nullthrows || _load_nullthrows()).default)(atom.workspace.paneForItem(getActiveTextEditor())).getPendingItem();}