'use strict';var _asyncToGenerator = _interopRequireDefault(require('async-to-generator'));var _promise;
...
function _load_promise() {return _promise = require('../../nuclide-commons/promise');}var _AtomTextEditor;
function _load_AtomTextEditor() {return _AtomTextEditor = require('../AtomTextEditor');}
var _react = _interopRequireWildcard(require('react'));
var _reactDom = _interopRequireDefault(require('react-dom'));var _testUtils;
function _load_testUtils() {return _testUtils = _interopRequireDefault(require('react-dom/test-utils'));}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
describe('nuclide-ui-atom-text-editor', () => {
  describe('when its `path` is set', () => {
    ...
    it('loads the desired `Grammar`', () => {
      // $FlowIgnore
      const element = (_testUtils || _load_testUtils()).default.renderIntoDocument(
      _react.createElement((_AtomTextEditor || _load_AtomTextEditor()).AtomTextEditor, { path: '.test' }));
  ...
  describe('providing a grammar', () => {
    ...
    afterEach(() => {if (!(
      grammar1 != null)) {throw new Error('Invariant violation: "grammar1 != null"');}
      atom.grammars.removeGrammarForScopeName(grammar1.scopeName);if (!(
      grammar2 != null)) {throw new Error('Invariant violation: "grammar2 != null"');}
    ...
    it('updates the underlying models grammar', () => {
      // $FlowIgnore
      const element = (_testUtils || _load_testUtils()).default.renderIntoDocument(
      _react.createElement((_AtomTextEditor || _load_AtomTextEditor()).AtomTextEditor, { path: '.test', grammar: grammar2 }));
  ...
  describe('when `readOnly`', () => {
    ...
    describe('is true', () => {
      beforeEach(() => {
        // $FlowIgnore
        element = (_testUtils || _load_testUtils()).default.renderIntoDocument(
        _react.createElement((_AtomTextEditor || _load_AtomTextEditor()).AtomTextEditor, { readOnly: true }));

      });

      it('allows copying', () => {if (!
        element) {throw new Error('Invariant violation: "element"');}
